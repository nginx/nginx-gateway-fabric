	...
	tests := []struct {
		...
		},
		{
			...
			gateway: &graph.Gateway{
				...
				EffectiveNginxProxy: &graph.EffectiveNginxProxy{WAF: &ngfAPIv1alpha2.WAFSpec{Enabled: true}},
				Policies:            []*graph.Policy{},
			},
			expWAFConfig: WAFConfig{
				Enabled:    true,
		...
		},
		{
			...
			gateway: &graph.Gateway{
				...
				EffectiveNginxProxy: &graph.EffectiveNginxProxy{WAF: &ngfAPIv1alpha2.WAFSpec{Enabled: false}},
				Policies: []*graph.Policy{
					{
