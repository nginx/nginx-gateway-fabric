...
type Backend struct {
	...
	// When set to AppProtocolH2C and no policy override is present, NGF will emit
	...
	// the BackendGroup carries AppProtocolH2C. If even one valid backend does not, NGF falls back
