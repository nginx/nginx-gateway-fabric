...
func TestDataAttributes(t *testing.T) {
	...
	data := Data{
		...
		NGFResourceCounts: NGFResourceCounts{
			...
			GatewayAttachedPayloadProcessorPolicyCount: 34,
			RouteAttachedPayloadProcessorPolicyCount:   35,
	...
	expected := []attribute.KeyValue{
		...
		attribute.Int64("GatewayAttachedPayloadProcessorPolicyCount", 34),
		attribute.Int64("RouteAttachedPayloadProcessorPolicyCount", 35),
...
func TestDataAttributesWithEmptyData(t *testing.T) {
	...
	expected := []attribute.KeyValue{
		...
		attribute.Int64("GatewayAttachedPayloadProcessorPolicyCount", 0),
		attribute.Int64("RouteAttachedPayloadProcessorPolicyCount", 0),
