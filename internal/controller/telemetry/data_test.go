...
func TestDataAttributes(t *testing.T) {
	...
	data := Data{
		...
		NGFResourceCounts: NGFResourceCounts{
			...
			GatewayAttachedWAFGatewayBindingPolicyCount: 25,
			RouteAttachedWAFGatewayBindingPolicyCount:   26,
	...
	expected := []attribute.KeyValue{
		...
		attribute.Int64("GatewayAttachedWAFGatewayBindingPolicyCount", 25),
		attribute.Int64("RouteAttachedWAFGatewayBindingPolicyCount", 26),
...
func TestDataAttributesWithEmptyData(t *testing.T) {
	...
	expected := []attribute.KeyValue{
		...
		attribute.Int64("GatewayAttachedWAFGatewayBindingPolicyCount", 0),
		attribute.Int64("RouteAttachedWAFGatewayBindingPolicyCount", 0),
