...
func (fake *FakePollerManager) ReconcilePoller(arg1 context.Context, arg2 waf.PollerConfig) {
...
func (fake *FakePollerManager) ReconcilePollerCalls(stub func(context.Context, waf.PollerConfig)) {
	fake.reconcilePollerMutex.Lock()
	defer fake.reconcilePollerMutex.Unlock()
	fake.ReconcilePollerStub = stub
}

func (fake *FakePollerManager) ReconcilePollerArgsForCall(i int) (context.Context, waf.PollerConfig) {
	fake.reconcilePollerMutex.RLock()
	defer fake.reconcilePollerMutex.RUnlock()
...
var _ waf.PollerManager = new(FakePollerManager)
