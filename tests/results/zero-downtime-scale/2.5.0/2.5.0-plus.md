...
- Dropped traffic continues for abrupt scaling with NGINX Plus (same issue tracked in https://github.com/nginx/nginx-gateway-fabric/issues/4683).
- Slightly higher latency compared to 2.4.0.
- Multiple NGINX pods abrupt scale up saw increased failures (2003 502s vs 1000 in 2.4.0).
- Gradual scaling tests maintain 100% success rate.
