...
- No connection errors observed in any test, an improvement over 2.6.0 which had connection refused/unreachable errors during gradual scaling.
- Latency is comparable to, and in some cases slightly higher than, 2.6.0.
