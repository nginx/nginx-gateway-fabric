...
func TestProxySettingsPolicyBuffering(t *testing.T) {
	t.Parallel()
	k8sClient := getKubernetesClient(t)
	...
	tests := []struct {
		...
		{
			name: "Validate valid Buffering settings are allowed",
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					...
					Buffers: &ngfAPIv1alpha1.ProxyBuffers{
						Number: 4,
						Size:   ngfAPIv1alpha1.Size("8k"),
					},
				},
			},
		},
		{
			name:       "Validate BufferSize pattern must match",
			wantErrors: []string{expectedBufferingBufferSizeFormatError},
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					BufferSize: helpers.GetPointer(ngfAPIv1alpha1.Size("2x")), // invalid suffix
				},
			},
		},
		{
			name:       "Validate Buffers.size pattern must match",
			wantErrors: []string{expectedBufferingSizeFormatError},
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					Buffers: &ngfAPIv1alpha1.ProxyBuffers{
						Number: 4,
						Size:   ngfAPIv1alpha1.Size("9999x"), // invalid pattern
					},
				},
			},
		},
		{
			name:       "Validate Buffers.number minimum is enforced",
			wantErrors: []string{expectedBufferingMinNumberError},
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
		...
		{
			name:       "Validate Buffers.number maximum is enforced",
			wantErrors: []string{expectedBufferingMaxNumberError},
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
		...
		{
			name: "Validate BusyBuffersSize can be smaller than BufferSize",
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					BufferSize:      helpers.GetPointer(ngfAPIv1alpha1.Size("16k")),
					BusyBuffersSize: helpers.GetPointer(ngfAPIv1alpha1.Size("8k")), // less than bufferSize
					Buffers: &ngfAPIv1alpha1.ProxyBuffers{
						Number: 4,
						Size:   ngfAPIv1alpha1.Size("8k"),
					},
		...
		{
			name: "Validate BusyBuffersSize greater than or equal to BufferSize",
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					BufferSize:      helpers.GetPointer(ngfAPIv1alpha1.Size("16m")),
					BusyBuffersSize: helpers.GetPointer(ngfAPIv1alpha1.Size("8g")), // much bigger than bufferSize
					Buffers: &ngfAPIv1alpha1.ProxyBuffers{
						Number: 4,
						Size:   ngfAPIv1alpha1.Size("8k"),
					},
		...
		{
			name: "Validate BusyBuffersSize equal to BufferSize is allowed",
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					BufferSize:      helpers.GetPointer(ngfAPIv1alpha1.Size("16k")),
					BusyBuffersSize: helpers.GetPointer(ngfAPIv1alpha1.Size("16k")), // equal to bufferSize
					Buffers: &ngfAPIv1alpha1.ProxyBuffers{
						Number: 4,
						Size:   ngfAPIv1alpha1.Size("8k"),
					},
		...
		{
			name:       "Validate BusyBuffersSize pattern must match",
			wantErrors: []string{expectedBufferingBusyBufferSizeFormatError},
			spec: ngfAPIv1alpha1.ProxySettingsPolicySpec{
				TargetRefs: []gatewayv1.LocalPolicyTargetReference{{
					Kind:  gatewayKind,
					Group: gatewayGroup,
				...
				Buffering: &ngfAPIv1alpha1.ProxyBuffering{
					BusyBuffersSize: helpers.GetPointer(ngfAPIv1alpha1.Size("8o")), // invalid suffix
				},
			},
		},
	}
