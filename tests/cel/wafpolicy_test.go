...
func TestWAFPolicyNIMLogProfileProfileName(t *testing.T) {
	t.Parallel()
	k8sClient := getKubernetesClient(t)
	logSource := "nimSource"

	nimLogSource := func(profileName string) *ngfAPIv1alpha1.LogSource {
		return &ngfAPIv1alpha1.LogSource{
			NIMSource: &ngfAPIv1alpha1.NIMLogProfileBundleSource{
				URL:         "https://nim.example.com",
				ProfileName: profileName,
	...
	tests := []struct {
	...
	}{
		{
			...
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: nimLogSource("my-profile"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
		...
		{
			name: "valid name with spaces and slashes is accepted",
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: nimLogSource("my log profile / version 1"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
		...
		},
		{
			...
			wantErrors: []string{fmt.Sprintf(expectedWAFLogProfileNamePatternErrorFmt, logSource)},
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: nimLogSource("invalid!name$"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			tt.spec.TargetRefs = []gatewayv1.LocalPolicyTargetReference{
				{
					Kind: gatewayKind, Group: gatewayGroup, Name: "test-gw",
				},
			}
			validateCrd(t, tt.wantErrors, newWAFPolicy(t, tt.spec), k8sClient)
		})
...
func TestWAFPolicyN1CLogProfileProfileName(t *testing.T) {
	t.Parallel()
	k8sClient := getKubernetesClient(t)
	logSource := "n1cSource"

	n1cLogSource := func(profileName string) *ngfAPIv1alpha1.LogSource {
		return &ngfAPIv1alpha1.LogSource{
			N1CSource: &ngfAPIv1alpha1.N1CLogProfileBundleSource{
				URL:         "https://n1c.example.com",
				Namespace:   "my-namespace",
	...
	tests := []struct {
	...
	}{
		{
			...
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: n1cLogSource("my-profile"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
		...
		},
		{
			...
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: n1cLogSource("my log profile / version 1"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
		...
		},
		{
			...
			spec: ngfAPIv1alpha1.WAFPolicySpec{
				SecurityLogs: []ngfAPIv1alpha1.WAFSecurityLog{
					{
						LogSource: n1cLogSource("invalid!name$"),
						Destination: ngfAPIv1alpha1.SecurityLogDestination{
							Type: ngfAPIv1alpha1.SecurityLogDestinationTypeStderr,
						},
					},
