...
func (in *AIGuardrails) DeepCopyInto(out *AIGuardrails) {
	*out = *in
	out.APITokenSecretRef = in.APITokenSecretRef
	if in.FailMode != nil {
		in, out := &in.FailMode, &out.FailMode
		*out = new(AIGuardrailsFailMode)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AIGuardrails.
func (in *AIGuardrails) DeepCopy() *AIGuardrails {
	if in == nil {
		return nil
	}
	out := new(AIGuardrails)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NginxProxySpec) DeepCopyInto(out *NginxProxySpec) {
	*out = *in
	...
	if in.AIGuardrails != nil {
		in, out := &in.AIGuardrails, &out.AIGuardrails
		*out = new(AIGuardrails)
		(*in).DeepCopyInto(*out)
	}
}
