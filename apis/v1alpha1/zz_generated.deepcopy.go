...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *JWTRemoteTLSConfig) DeepCopyInto(out *JWTRemoteTLSConfig) {
	*out = *in
	if in.SecretRef != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new JWTRemoteTLSConfig.
func (in *JWTRemoteTLSConfig) DeepCopy() *JWTRemoteTLSConfig {
	if in == nil {
		return nil
	}
	out := new(JWTRemoteTLSConfig)
