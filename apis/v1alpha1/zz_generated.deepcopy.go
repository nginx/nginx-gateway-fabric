...
func (in *APResourceReference) DeepCopyInto(out *APResourceReference) {
	*out = *in
	if in.Namespace != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new APResourceReference.
func (in *APResourceReference) DeepCopy() *APResourceReference {
	if in == nil {
		return nil
	}
	out := new(APResourceReference)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WAFGatewayBindingPolicySpec) DeepCopyInto(out *WAFGatewayBindingPolicySpec) {
	*out = *in
	...
	if in.APPolicySource != nil {
		in, out := &in.APPolicySource, &out.APPolicySource
		*out = new(APResourceReference)
		(*in).DeepCopyInto(*out)
	}
...
func (in *WAFSecurityLog) DeepCopyInto(out *WAFSecurityLog) {
	*out = *in
	...
	in.APLogConfSource.DeepCopyInto(&out.APLogConfSource)
