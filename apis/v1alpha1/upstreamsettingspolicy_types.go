...
type UpstreamSettingsPolicySpec struct {
	...
	// ClusterIP, which is useful for service mesh compatibility (e.g. Linkerd, Istio) and F5 BIG-IP/CIS
	// integration patterns that require traffic to traverse the Service VIP.
	// Defaults to false.
	//
	// +optional
