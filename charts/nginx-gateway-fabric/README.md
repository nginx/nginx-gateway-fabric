...
| `nginx.serviceMonitor.annotations` | Annotations for the data plane ServiceMonitor. | object | `{}` |
| `nginx.serviceMonitor.enable` | Create a ServiceMonitor resource for the data plane. | bool | `false` |
| `nginx.serviceMonitor.interval` | Scrape interval for the data plane ServiceMonitor (e.g. "30s"). Empty uses Prometheus default. | string | `""` |
| `nginx.serviceMonitor.labels` | Additional labels for the data plane ServiceMonitor. | object | `{}` |
...
| `nginxGateway` | The nginxGateway section contains configuration for the NGINX Gateway Fabric control plane deployment. | object | `{"affinity":{},"autoscaling":{"enable":false},"config":{"logging":{"level":"info"}},"configAnnotations":{},"extraVolumeMounts":[],"extraVolumes":[],"gatewayClassAnnotations":{},"gatewayClassName":"nginx","gatewayControllerName":"gateway.nginx.org/nginx-gateway-controller","gwAPIExperimentalFeatures":{"enable":false},"gwAPIInferenceExtension":{"enable":false,"endpointPicker":{"disableTLS":false,"skipVerify":true}},"image":{"pullPolicy":"Always","repository":"ghcr.io/nginx/nginx-gateway-fabric","tag":"edge"},"kind":"deployment","labels":{},"leaderElection":{"enable":true,"lockName":""},"lifecycle":{},"metrics":{"enable":true,"port":9113,"secure":false,"serviceMonitor":{"annotations":{},"enable":false,"interval":"","labels":{}}},"name":"","nodeSelector":{},"podAnnotations":{},"priorityClassName":"","productTelemetry":{"enable":true},"readinessProbe":{"enable":true,"initialDelaySeconds":3,"port":8081},"replicas":1,"resources":{},"service":{"annotations":{},"labels":{}},"serviceAccount":{"annotations":{},"imagePullSecret":"","imagePullSecrets":[],"name":""},"snippets":{"enable":false},"snippetsFilters":{"enable":false},"terminationGracePeriodSeconds":30,"tolerations":[],"topologySpreadConstraints":[],"watchNamespaces":[]}` |
...
| `nginxGateway.metrics.serviceMonitor.annotations` | Annotations for the control plane ServiceMonitor. | object | `{}` |
| `nginxGateway.metrics.serviceMonitor.enable` | Create a ServiceMonitor resource for the control plane. | bool | `false` |
| `nginxGateway.metrics.serviceMonitor.interval` | Scrape interval for the control plane ServiceMonitor (e.g. "30s"). Empty uses Prometheus default. | string | `""` |
| `nginxGateway.metrics.serviceMonitor.labels` | Additional labels for the control plane ServiceMonitor. | object | `{}` |
