...
| `nginxGateway` | The nginxGateway section contains configuration for the NGINX Gateway Fabric control plane deployment. | object | `{"affinity":{},"autoscaling":{"enable":false},"config":{"logging":{"level":"info"}},"configAnnotations":{},"extraVolumeMounts":[],"extraVolumes":[],"gatewayClassAnnotations":{},"gatewayClassName":"nginx","gatewayControllerName":"gateway.nginx.org/nginx-gateway-controller","gwAPIExperimentalFeatures":{"enable":false},"gwAPIInferenceExtension":{"enable":false,"endpointPicker":{"disableTLS":false,"skipVerify":true}},"image":{"pullPolicy":"Always","repository":"ghcr.io/nginx/nginx-gateway-fabric","tag":"edge"},"kind":"deployment","labels":{},"leaderElection":{"enable":true,"lockName":""},"lifecycle":{},"metrics":{"enable":true,"port":9113,"secure":false},"name":"","nodeSelector":{},"plmStorage":{"credentialsSecretName":"","tls":{"caCertPath":"","clientCertPath":"","clientKeyPath":"","insecureSkipVerify":false},"url":""},"podAnnotations":{},"priorityClassName":"","productTelemetry":{"enable":true},"readinessProbe":{"enable":true,"initialDelaySeconds":3,"port":8081},"replicas":1,"resources":{},"service":{"annotations":{},"labels":{}},"serviceAccount":{"annotations":{},"imagePullSecret":"","imagePullSecrets":[],"name":""},"snippets":{"enable":false},"snippetsFilters":{"enable":false},"terminationGracePeriodSeconds":30,"tolerations":[],"topologySpreadConstraints":[],"watchNamespaces":[]}` |
...
| `nginxGateway.plmStorage` | PLM (Policy Lifecycle Manager) storage configuration for WAF bundles. Used when WAF is enabled to fetch APPolicy and APLogConf bundles from S3-compatible storage. | object | `{"credentialsSecretName":"","tls":{"caCertPath":"","clientCertPath":"","clientKeyPath":"","insecureSkipVerify":false},"url":""}` |
| `nginxGateway.plmStorage.credentialsSecretName` | The name of the Secret containing S3 credentials for PLM storage. The Secret should have "accessKeyId" and "secretAccessKey" data fields. Must exist in the same namespace as the helm release. If not provided, anonymous access is used. | string | `""` |
| `nginxGateway.plmStorage.tls` | TLS configuration for PLM storage connections. | object | `{"caCertPath":"","clientCertPath":"","clientKeyPath":"","insecureSkipVerify":false}` |
| `nginxGateway.plmStorage.tls.caCertPath` | Path to the CA certificate file for TLS verification. | string | `""` |
| `nginxGateway.plmStorage.tls.clientCertPath` | Path to the client certificate file for mutual TLS. | string | `""` |
| `nginxGateway.plmStorage.tls.clientKeyPath` | Path to the client key file for mutual TLS. | string | `""` |
| `nginxGateway.plmStorage.tls.insecureSkipVerify` | Skip TLS certificate verification. Use only for testing. | bool | `false` |
| `nginxGateway.plmStorage.url` | The S3-compatible storage endpoint URL. | string | `""` |
