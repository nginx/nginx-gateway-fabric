...
| `nginxGateway` | The nginxGateway section contains configuration for the NGINX Gateway Fabric control plane deployment. | object | `{"affinity":{},"autoscaling":{"annotations":{},"behavior":{},"enable":false,"maxReplicas":10,"metrics":[],"minReplicas":1,"targetCPUUtilizationPercentage":50,"targetMemoryUtilizationPercentage":50},"config":{"logging":{"level":"info"}},"configAnnotations":{},"extraVolumeMounts":[],"extraVolumes":[],"gatewayClassAnnotations":{},"gatewayClassName":"nginx","gatewayControllerName":"gateway.nginx.org/nginx-gateway-controller","gwAPIExperimentalFeatures":{"enable":false},"gwAPIInferenceExtension":{"enable":false,"endpointPicker":{"disableTLS":false,"skipVerify":true}},"image":{"pullPolicy":"Always","repository":"ghcr.io/nginx/nginx-gateway-fabric","tag":"edge"},"kind":"deployment","labels":{},"leaderElection":{"enable":true,"lockName":""},"lifecycle":{},"metrics":{"enable":true,"port":9113,"secure":false},"name":"","nodeSelector":{},"podAnnotations":{},"podDisruptionBudget":{"annotations":{},"enable":false,"maxUnavailable":"","minAvailable":""},"priorityClassName":"","productTelemetry":{"enable":true},"readinessProbe":{"enable":true,"initialDelaySeconds":3,"port":8081},"replicas":1,"resources":{},"service":{"annotations":{},"labels":{}},"serviceAccount":{"annotations":{},"imagePullSecret":"","imagePullSecrets":[],"name":""},"snippets":{"enable":false},"snippetsFilters":{"enable":false},"terminationGracePeriodSeconds":30,"tolerations":[],"topologySpreadConstraints":[],"watchNamespaces":[]}` |
...
| `nginxGateway.podDisruptionBudget` | PodDisruptionBudget configuration for the NGINX Gateway Fabric control plane. | object | `{"annotations":{},"enable":false,"maxUnavailable":"","minAvailable":""}` |
| `nginxGateway.podDisruptionBudget.annotations` | Set of custom annotations for the PDB object. | object | `{}` |
| `nginxGateway.podDisruptionBudget.enable` | Enable or disable PodDisruptionBudget for the control plane. | bool | `false` |
| `nginxGateway.podDisruptionBudget.maxUnavailable` | The maximum number of pods that can be unavailable. Mutually exclusive with minAvailable. | string | `""` |
| `nginxGateway.podDisruptionBudget.minAvailable` | The minimum number of pods that must be available. Mutually exclusive with maxUnavailable. | string | `""` |
