...
helm install nginx-gateway $NGF_CHART_PATH \
  ...
  --set nginx.plus=true \
  --set nginxGateway.plmStorage.url=my-plm-f5-waf-seaweed-filer.${NAP_NAMESPACE}.svc.cluster.local:8333 \
  --set nginxGateway.plmStorage.credentialsSecretName=${NAP_NAMESPACE}/my-plm-f5-waf-seaweedfs-auth \
